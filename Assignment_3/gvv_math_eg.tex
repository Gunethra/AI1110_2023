...
(a) Find the conditional probability of obtaining a
sum greater than 9, given that the black die
resulted in a 5.
(b) Find the conditional probability of obtaining
...
\textbf{Solution:}
Let X be a random variable defined as the value given by the pointer. The distribution is uniform since all the outcomes are equally likely.
\begin{align}
